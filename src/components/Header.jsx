...
const Header = ()=>{
    ...
    return( 
        <header className=" shadow-[2px_0px_10px_#ccc]  py-5 px-5 md:px-0 font-[400] font-[helvetica]">
           ...
           <div className="flex gap-7 ">
                <button className="border border-primary   w-[110px] text-sm lg:text-[1.5rem] lg:w-[190px] font-bold lg:font-[400]   py-4 rounded-lg">Login</button>
                <button className="text-white bg-primary  shadow-[0px_4px_4px_0px_#FF617C33]  w-[110px] text-sm  lg:text-[1.5rem] lg:w-[190px] font-bold lg:font-[400] py-4 rounded-[0.65rem]">Sign up</button>
           </div>
                </div>
        </header>
    )
