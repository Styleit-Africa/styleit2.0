                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <FormItem className="shadow-md flex-[0.3] md:flex-[0.6] pb-10 pt-9 md:py-6 px-5 relative  rounded-3xl md:rounded-xl">
                                <FormControl>
                                  <RadioGroupItem value="Fashion" id="fashion" className='border-green-500  absolute top-3 right-3 p-3'/>
                                </FormControl>
                                <FormLabel htmlFor="fashion" className="cursor-pointer block  w-full">
