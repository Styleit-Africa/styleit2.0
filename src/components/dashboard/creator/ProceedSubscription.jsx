            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div className='flex flex-col md:flex-row gap-6 md:gap-12 basis-[50%]'>
                        <div className='mt-6 md:mt-0'>
                            <p className='capitalize font-[700] '>full name:<span className='ml-3 md:ml-0 font-[500]'>Opeyemi Moses</span></p>
                            <p className='capitalize mt-2 font-[700] '>payment date:<span className='ml-3 md:ml-0 font-[500]'>22-08-2024</span></p>
                            <p className='capitalize mt-2 font-[700] '>amount paid:<span className='ml-3 md:ml-0 font-[500]'>500.00</span></p>
                        </div>
                        <div>
                            <p className='capitalize font-[700] '>Business name:<span className='ml-3 md:ml-0 font-[500]'>ariky stitches</span></p>
                            <p className='capitalize mt-2 font-[700] '>payment reference:<span className='ml-3 md:ml-0 font-[500]'>25903501</span></p>
                    ...
                    <Link to={`/creator/subscriptions/${singleSubscription.id}`} className='md:hidden capitalize block ont-[500] text-lg px-0 py-4 md:py-6 rounded-xl bg-white border border-primary hover:bg-primary hover:text-white
