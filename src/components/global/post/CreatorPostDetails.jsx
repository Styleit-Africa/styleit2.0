...
import CreatorPostCommentContainer from '../comment/CreatorPostCommentContainer';

const CreatorPostDetails = ({_post,setPostId}) => {
        ...
        const post = {..._post,creator:{firstName:'sulaiman',lastName:'Yusuf'}}
  ...
  return (
   ...
   <div className='flex justify-between text-primary my-3'>
    ...
    <h1 className='text-lg capitalize font-[500] mt-3'>comments ({post.Comment_Count})</h1>
        {
          post?.post_comment.length === 0 ? <div className='text-center mt-3'>
          ...
          <CreatorPostCommentContainer userProfile={post.creator} post={post} />
        }
