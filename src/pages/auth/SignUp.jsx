...
const SignUp = ()=> {
  ...
  return (
    <section className='flex flex-col md:flex-row md:max-w-[800px] mx-auto  pt-20 font-lato '>
        <Reasons isSignUp={true} image={african} header="join as fashion designers and make your works known"/>
